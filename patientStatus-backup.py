...
class Ui_patientStatus(object):
    def setupUi(self, patientStatus):
        ...
        self.loungeTable.raise_()
        self.tabWidget.addTab(self.loungeTab, "")

# ----------------------- end of lounge tab ----------------------------

# ---------------------- beginning of (downstream) ward tab -------------------

        self.wardTab = QtWidgets.QWidget()
        self.wardTab.setObjectName("wardTab")

        self.wardTable = QtWidgets.QTableWidget(self.bedTab)
        ...
        self.wardTable.setColumnCount(7)
        ...
        self.wardTable.raise_()
        self.tabWidget.addTab(self.wardTab, "")

# ------------- end of downstream tab -------------
    ...
    def retranslateUi(self, patientStatus):
        ...
        #self.buttEditWard.setText(_translate("patientStatus", "Delete Patient"))
        ...
        item.setText(_translate("patientStatus", "Ward"))
