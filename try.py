...
class Ui_registerform(object):
    def setupUi(self, registerform):
        ...
        self.pushButton = QtWidgets.QPushButton(registerform)
        ...
        self.label.setGeometry(QtCore.QRect(290, 110, 91, 16))
    ...
    def retranslateUi(self, registerform):
        ...
        self.label.setText(_translate("registerform", "Self-isolation:"))
